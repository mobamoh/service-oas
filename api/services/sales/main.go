...
import (
	...
	"github.com/mobamoh/service-oas/api/services/sales/build/all"
	"github.com/mobamoh/service-oas/app/sdk/debugger"
...
func run(ctx context.Context, log *logger.Logger) error {
	...
	cfg := struct {
		...
		Tempo struct {
			...
			ServiceName string  `conf:"default:gom-core"`
	...
	pool, err := sqldb.Open(ctx, sqldb.Config{
		User:         cfg.DB.User,
	...
	go func() {
		...
		if err := http.ListenAndServe(cfg.Web.DebugHost, debugger.Mux()); err != nil {
	...
	webAPI, err := mux.WebAPI(cfgMux, buildRoutes())
	if err != nil {
		serverErrors <- err
	}
